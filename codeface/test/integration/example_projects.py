...
def get_example_project_1(tagging="tag", randomise_email_case=False):
    ...
    # === INIZIO PROGETTO ===
    project.email("dev1", Adam, "2013-01-07T15:00:00", "Project start", "Foo!")
    project.commit(Adam, Adam, "2013-01-07T16:00:00", {"README": "FOO\nBOO"}, signoff=[Adam])
    project.tag_rc(Adam, "2013-01-07T16:30:00")
    project.tag_release(Adam, "2013-01-07T16:59:00")
    ...
    # === BLOCCO AGGIUNTO PER PROXIMITY / FEATURE ===
    if tagging in ["proximity", "feature"]:
        # Adam crea un file con codice e feature
        code_c_adam = (
            "int main(){\n"
            "    int x = 0;\n"
            "    /* Adam init section */\n"
        ...
        carp_c_adam = (
            "#ifdef FEATURE_X\n"
            "int feature_func(){\n"
            "    int a = 0; /* Adam feature A */\n"
            "    return a;\n"
            "}\n"
            "#endif\n"
        )
        project.commit(
            Adam, Adam, "2013-01-08T15:00:00",
            {"src/code.c": code_c_adam, "src/carp.c": carp_c_adam},
            signoff=[Adam]
        )

        # Bill modifica le stesse righe (vicinanza + stessa feature)
        code_c_bill = (
            "int main(){\n"
            "    int x = 0;\n"
            "    int y = x + 1; /* Bill change near Adam */\n"
            "    /* Adam init section */\n"
            "    return 0;\n"
            "};\n"
        )
        carp_c_bill = (
            "#ifdef FEATURE_X\n"
            "int feature_func(){\n"
            "    int a = 1; /* Bill also feature A */\n"
            "    return a;\n"
            "}\n"
            "#endif\n"
        )
        project.commit(
            Bill, Bill, "2013-01-09T10:00:00",
            {"src/code.c": code_c_bill, "src/carp.c": carp_c_bill},
            signoff=[Bill, Clara]
        )

    # === CONTENUTI CONDIZIONALI STANDARD ===
    ...
    # === COMMIT SUCCESSIVI ===
    commit1_files = {"README": "Foo\nBoo", "src/code.c": code_c_adam}
    if carp_c_adam is not None:
        commit1_files["src/carp.c"] = carp_c_adam
        project.commit(Adam, Adam, "2013-01-08T15:30:00", commit1_files, signoff=[Adam])
        project.tag_rc(Adam, "2013-01-08T15:45:00")
        project.email("dev1", Bill, "2013-01-09T14:00:00", "Re: Mail 2b bug", "A fix for the bug!")
        if tagging == "proximity":
            code_c_bill = (
                "int main(){\n"
                "    int a = 0;\n"
                "    int b = a + 1; /* Bill change */\n"
                "    /* Adam init */\n"
                "    return 0;\n"
                "};\n"
            )
        else:
            code_c_bill = "int main() {return 0;};"
        ...
        if tagging == "feature":
            carp_c_bill = (
                ...
                "    int a = 0;\n"
                "#if (defined(A))\n"
                "    int b = 1; /* Bill also in feature A */\n"
                "#endif\n"
                "    return 0;\n"
                "};\n"
            )
        else:
            carp_c_bill = "int main() {return -1;};"

        commit2_files = {
            "README": "Foo\nBoo",
            "src/code.c": code_c_bill,
            "src/carp.c": carp_c_bill
        }
        project.commit(Bill, Bill, "2013-01-09T15:30:00", commit2_files, signoff=[Bill, Clara])

    # === EMAILS E RELEASES SUCCESSIVE ===
    project.email("dev1", Adam, "2013-01-10T14:00:00", "Re: revert 2a commit", "I will revert the commit!")
    project.email("dev1", Adam, "2013-01-10T14:00:01", "Re: revert 2b bug", "I will revert the bug!")
    project.email("dev1", Adam, "2013-01-10T14:00:02", "Re: revert 2c feature", "I will revert the feature!")
    project.email("dev1", Adam, "2013-01-10T14:00:03", "Re: revert 2d Message", "I will revert the message!")
    ...
    project.email("dev1", "=2134garbled-email-23489", "2013-01-10T14:05:04", "Spam", "foo")
    project.commit(
        Adam, Adam, "2013-01-10T18:00:00",
        {"README": "Foo\nBoo", "src/code.c": "int main() {\n    return 0;\n};"},
        signoff=[Adam, Peter]
    )
    ...
    # === ALTRI COMMIT E RELEASE 2 ===
    project.commit(
        Max, Adam, "2013-01-14T12:30:42",
        {"README": "Foo\nBoo", "src/code.c": "int main() {\n    return 0;\n};",
         "src/newcode.c": "int answer() {\n    return 42;\n};"},
        signoff=[Adam, Max]
    )
    ...
    # === FASE DI RC E RELEASE ===
    project.commit(
        Max, Max, "2013-01-14T12:50:42",
        {"README": "Foo\nBoo", "src/code.c": "int main() {\n    return 0;\n};",
         "src/answer.c": "int answer() {\n    return 42;\n};"},
        signoff=[Adam, Max]
    )
    project.commit(
        Clara, Max, "2013-01-15T12:42:42",
        {"README": "Foo\nBoo", "src/code.c": "int main() {\n    return 0;\n};",
         "src/answer.c": "int answer() {\n    return 42;\n};",
         "Makefile": "all: src/code.o\n};"},
        signoff=[Adam, Max, Clara]
